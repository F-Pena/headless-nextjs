...
import { getCustomerPost } from '@/content/queries'
import { documentToReactComponents } from '@contentful/rich-text-react-renderer'
  
  export default async function CustomerSingle({ params }: { params: { slug: string } }) {
    const data = await getCustomerPost(params.slug);
                      ...
                      <div className="px-5 py-6">
                        <div className="mb-5">
                          <div className="flex items-center space-x-4">
                            ...
                            <div className="text-lg font-semibold text-slate-100">{content.customer.title}</div>
                          </div>
                        </div>
